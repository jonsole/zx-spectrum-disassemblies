...
| The Hobbit (1982, Melbourne House) | partial &mdash; 316 of 366 routines named: parser, messages, pictures, actions, characters and timers; the whole database decoded | `scripts/build_hobbit.py` |
