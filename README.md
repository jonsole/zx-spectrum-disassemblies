...
| The Hobbit (1982, Melbourne House) | partial &mdash; 297 of 366 routines named: parser, messages, pictures, actions, characters and timers; the database decoded, the variables not yet | `scripts/build_hobbit.py` |
