...
E $74BA What sets $B6E8 and $B6EA is not established. Two variables that decide whether a verb takes its -s is subject agreement, and the game does have to compose sentences about both you and everyone else, but that is a reading of the mechanism rather than something traced back to whatever writes them.
